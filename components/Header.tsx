...
const Header = () => {
    ...
    if(router.pathname !== '/')
        return (
            <div className='grid grid-cols-2 lg:grid-cols-3 justify-center border-b-2 border-gray-200 pb-3 bg-gray-800 w-full z-50 fixed items-center'>
                <div className='flex flex-row justify-center lg:justify-end'>
                    <select>
                        <option>Localizacion</option>
                    </select>
                </div>
                <div className='flex justify-around md:justify-start lg:justify-center text-2xl'>
                    <h1 className='text-white'>GoPets!</h1>
                </div>
                <div className='hidden lg:flex gap-5 pt-1'>
